// $Id: type_checker.cpp,v 1.15 2016/04/11 19:30:24 ist178929 Exp $ -*- c++ -*-
#include <string>
...
void zu::type_checker::do_indexation_node(zu::indexation_node * const node, int lvl) {
...
void zu::type_checker::do_zuidentifier_node(zu::zuidentifier_node * const node, int lvl) {
	//FIXME: Complete method
}
...
void zu::type_checker::do_memalloc_node(zu::memalloc_node * const node, int lvl) {
	//FIXME: Complete method
}
...
void zu::type_checker::do_variableDeclaration_node(zu::variableDeclaration_node * const node, int lvl) {
	//FIXME: Complete method
}

void zu::type_checker::do_variableDefinition_node(zu::variableDefinition_node * const node, int lvl) {
	//FIXME: Complete method
}

void zu::type_checker::do_expressionAsInstruction_node(zu::expressionAsInstruction_node * const node, int lvl) {
	//FIXME: Complete method
}
