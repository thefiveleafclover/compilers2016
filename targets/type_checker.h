// $Id: type_checker.h,v 1.14 2016/04/11 11:44:24 ist178929 Exp $ -*- c++ -*-
...
namespace zu {
  ...
  public:
    void do_indexation_node(zu::indexation_node * const node, int lvl);
  ...
  public:
    //void do_for_node(zu::while_node * const node, int lvl);
    ...
    void do_zuidentifier_node(zu::zuidentifier_node * const node, int lvl);
    void do_identifier_node(cdk::identifier_node * const node, int lvl);
    void do_block_node(zu::block_node * const node, int lvl);
    void do_memalloc_node(zu::memalloc_node * const node, int lvl);
    ...
    void do_variableDeclaration_node(zu::variableDeclaration_node * const node, int lvl);  
    void do_variableDefinition_node(zu::variableDefinition_node * const node, int lvl);    
    void do_expressionAsInstruction_node(zu::expressionAsInstruction_node * const node, int lvl);    
