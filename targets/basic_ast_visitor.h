// $Id: basic_ast_visitor.h,v 1.15 2016/04/11 11:44:24 ist178929 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_zuidentifier_node(zu::zuidentifier_node * const node, int lvl) = 0;
...
public:
  virtual void do_memalloc_node(zu::memalloc_node * const node, int lvl) = 0;
  virtual void do_indexation_node(zu::indexation_node * const node, int lvl) = 0;
...
public:
  virtual void do_expressionAsInstruction_node(zu::expressionAsInstruction_node * const node, int lvl) = 0;    
  virtual void do_variableDeclaration_node(zu::variableDeclaration_node * const node, int lvl) = 0;    
  virtual void do_variableDefinition_node(zu::variableDefinition_node * const node, int lvl) = 0;    
  ...
  virtual void do_funcall_node(zu::funcall_node * const node, int lvl) = 0;
...
public:
  ...
  virtual void do_apply_node(zu::apply_node * const node, int lvl) = 0;
