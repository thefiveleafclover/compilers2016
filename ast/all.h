...
class memalloc_node; 
class lvalue_node; 
class zuidentifier_node; 
class functionDeclaration_node; 
class or_node; 
class identity_node; 
class variableDeclaration_node; 
class read_node; 
class return_node; 
...
class if_else_node; 
class not_node; 
class variableDefinition_node; 
class and_node; 
class function_node; 
class assignment_node; 
class expressionAsInstruction_node; 
class apply_node; 
class for_node; 
class if_node; 
class block_node; 
...
#include "ast/variableDeclaration_node.h"
...
#include "ast/variableDefinition_node.h"
#include "ast/and_node.h"
#include "ast/function_node.h"
#include "ast/assignment_node.h"
#include "ast/expressionAsInstruction_node.h"
